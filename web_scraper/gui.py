...
class ScraperGUI(tk.Frame):
    def __init__(self, master=None):
        ...
        self.master.geometry("1200x700") # Increased size for data table
    ...
    def create_scraper_control_widgets(self, parent_tab):
        ...
        self.output_text = tk.Text(log_frame, wrap=tk.WORD, state=tk.DISABLED, height=20)
    ...
    def refresh_data_view(self):
        ...
        try:
            ...
            for product in products:
                # Ensure all columns have a value to avoid errors
    ...
    def finalize_scraper_run(self):
        ...
        messagebox.showinfo("Success", "Scraping process completed! You can now view the results in the 'Data Viewer' tab after refreshing.")
